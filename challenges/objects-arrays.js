...
const universities = graduates.map( element => { return element.university} ).sort();
...
const unisWithUni = graduates.filter(element => element.university.includes("Uni"));
...
*/
const displayNames = []; 
let grabbed = zooAnimals.forEach(element => { displayNames.push(`Name: ${element.animal_name}, Scientific Name: ${element.scientific_name}`) });
